...
- Name: ui-ux-verification.spec.ts >> VendorFlow UI/UX Verification >> 04: Orders page loads and shows empty state with demo data button
- Location: tests/e2e/ui-ux-verification.spec.ts:68:3
