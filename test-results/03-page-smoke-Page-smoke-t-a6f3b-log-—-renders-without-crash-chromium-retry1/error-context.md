...
- Name: 03-page-smoke.spec.ts >> Page smoke tests — all 10 critical pages >> Products Catalog — renders without crash
- Location: tests/e2e/03-page-smoke.spec.ts:37:5

# Error details

```
Error: Products Catalog should render visible content
